...
const NewShareModal = ({ listing, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-3 animate-fadeIn overflow-y-auto">
      <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl max-w-sm w-full p-3 my-2 relative shadow-2xl border border-gray-700 animate-slideUp max-h-[95vh] overflow-y-auto">
        <button
          onClick={onClose}
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">Create your card</p>
          </div>
        </div>

        {/* Card Preview */}
        <div className="mb-3 rounded-xl overflow-hidden shadow-2xl border border-gray-700" style={{ aspectRatio: '1/1', maxWidth: '280px', margin: '0 auto' }}>
        ...
        <div className="grid grid-cols-2 gap-2 mb-2">
          <button
            onClick={handleShare}
            disabled={loading}
            className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-semibold py-2 px-3 rounded-lg flex items-center justify-center gap-1.5 text-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
          >
          ...
          <button
            ...
            disabled={loading}
            className="bg-gray-700 hover:bg-gray-600 text-white font-semibold py-2 px-3 rounded-lg flex items-center justify-center gap-1.5 text-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
          >
            <Download size={14} />
            Download
          </button>
        ...
        {/* Caption */}
        {shareData && (
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-2.5 border border-gray-700">
            <div className="flex items-center justify-between mb-1">
              <div className="text-xs font-medium text-gray-400">Caption</div>
              <button
                onClick={async () => {
