      ...
      <div className="px-6 -mt-4">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-lg mb-6">
          <div className="text-center mb-6">
            ...
            <div className="inline-flex items-center gap-3 bg-slate-50 border-2 border-slate-300 rounded-2xl px-6 py-3 mb-4">
              <span className="text-2xl font-bold text-slate-700 tracking-wider">
