          ...
          <div className="h-full w-full flex flex-col p-5 py-8">
            ...
            <div className="h-[70%] bg-gray-900 flex flex-col flex-shrink-0 overflow-hidden">
              <div className="px-3.5 pt-3 pb-2 flex flex-col h-full">
                ...
                {/* Bottom Card Footer - Date, Source, Category */}
                <div className="pt-2.5 border-t border-gray-800 flex-shrink-0">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-1.5 py-2 bg-gray-800 text-gray-300 rounded-lg text-[11px] font-medium active:scale-[0.98] transition-transform"
                    >
                      <Share2 size={12} />
                      <span>शेयर</span>
                    </button>
                    ...
                    {currentArticle.sourceUrl && (
                      <a
                        ...
                        className="flex-1 flex items-center justify-center gap-1.5 py-2 bg-emerald-500 text-white rounded-lg text-[11px] font-semibold active:scale-[0.98] transition-transform"
                      >
                        <span>पूरी खबर</span>
